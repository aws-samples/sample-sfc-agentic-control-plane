...
# Define the repository path — use an explicit env var override or the known
# absolute container path (/app/sfc-repo) so the path is always correct
# regardless of how Python resolves __file__ at MCP server startup.
REPO_PATH = os.environ.get("SFC_REPO_PATH", "/app/sfc-repo")
